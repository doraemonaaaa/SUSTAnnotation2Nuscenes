...
# ego_world_translation = np.array([-5.15,  8.45,  0.  ])
# ego_world_rotation = Quaternion(0.000, +0.000, -0.109, +0.994)  # wxyz
# box_ego_translation = [-17.09543310071744, 0.4719478026206075, 0.33804071809034153]
# box_ego_rotation = (0, 0, 3.114699304681241)
